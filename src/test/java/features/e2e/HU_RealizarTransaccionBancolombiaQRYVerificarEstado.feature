Feature: Realizar transacciones con la API de Wompi y verificar estado
    ...
    Como usuario que consume los servicios integrados de Wompi
    Quiero realizar transacciones con la API de Wompi y verificar el estado de las mismas
    Para asegurar que los pagos se realicen correctamente
